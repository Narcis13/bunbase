...
Plans:
- [x] 10-01-PLAN.md — Auth types, password validation, auth collection schema (Wave 1)
- [x] 10-02-PLAN.md — User JWT tokens and refresh token storage (Wave 1)
- [x] 10-03-PLAN.md — Signup, login, token refresh endpoints (Wave 2)
- [x] 10-04-PLAN.md — Email verification flow with secure tokens (Wave 2)
- [x] 10-05-PLAN.md — Password reset flow with secure tokens (Wave 2)
- [x] 10-06-PLAN.md — Auth middleware and collection rules (Wave 3)
...
Plans:
- [x] 12-01-PLAN.md — SSE message formatting and RealtimeManager class (Wave 1)
- [x] 12-02-PLAN.md — Topic parsing and subscription matching (Wave 1)
- [x] 12-03-PLAN.md — SSE connection endpoint with keep-alive (Wave 2)
- [x] 12-04-PLAN.md — Subscription management endpoint (Wave 2)
- [x] 12-05-PLAN.md — Event broadcasting with permission filtering (Wave 3)
- [x] 12-06-PLAN.md — Inactivity cleanup and integration tests (Wave 4)
