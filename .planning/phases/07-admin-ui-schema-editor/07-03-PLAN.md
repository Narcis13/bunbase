...
must_haves:
  truths:
    ...
    - "Admin can select field type from dropdown"
    - "Admin can select target collection for relation fields"
  artifacts:
  ...
  key_links:
    ...
    - from: "src/admin/components/schema/SchemaView.tsx"
      to: "parent component"
      via: "onRefreshCollections callback after field mutations"
      pattern: "onRefreshCollections"
---
...
```
  ...
  <done>SchemaView container with fields table, add/edit sheet, delete confirmations, and onRefreshCollections callback for sidebar updates.</done>
</task>
...
7. SchemaView calls onRefreshCollections after field mutations
8. Delete confirmations warn about data loss
9. All TypeScript files compile without errors
</verification>
...
6. SchemaView triggers onRefreshCollections callback after successful field mutations
7. Delete dialogs show appropriate warnings about data loss
</success_criteria>
